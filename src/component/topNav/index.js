...
import JINDO from "assets/logo/JINDO.png"
...
function Topnav () {
    ...
    return (
        ...
        <SubTemplateBlockVertical>        
            <div class="flex flex-wrap items-center justify-between mx-auto pb-5">
                <div class="flex flex-row">
                <img src={JINDO} alt="Flowbite Logo" height="8px" width="50px" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">JINDO</span>
                </div>
